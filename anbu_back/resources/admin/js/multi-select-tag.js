function MultiSelectTag (el, customs = {shadow: false, rounded:true}) {
    ...
    // Get the select input element and the containing div element
    const selectInput = document.getElementById('categories');
    const selectBodyBlock = document.querySelector('.body.rounded');

    // Check if the select input has the 'is-invalid' class
    if (selectInput.classList.contains('is-invalid')) {
        // Add a class to the containing div element
        selectBodyBlock.classList.add('is-invalid');
    }
